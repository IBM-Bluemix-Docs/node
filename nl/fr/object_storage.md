...
4. Localisez les valeurs de clé de données d'identification à utiliser ultérieurement pour l'initialisation du kit SDK :
    ...
    * _**endpoint**_ - Noeud final public pour votre stockage d'objets Cloud. Le noeud final est disponible depuis le [tableau de bord {{site.data.keyword.cloud_notm}} ![Icône de lien externe](../icons/launch-glyph.svg "Icône de lien externe")](https://console.bluemix.net/dashboard/apps){: new_window}.
    ...
    * _**resource-instance-id**_ - ID ressource de votre stockage d'objets Cloud. L'ID ressource est disponible depuis l'[interface CLI {{site.data.keyword.cloud_notm}}](../cli/index.html) ou le [tableau de bord {{site.data.keyword.cloud_notm}} ![Icône de lien externe](../icons/launch-glyph.svg "Icône de lien externe")](https://console.bluemix.net/dashboard/apps){: new_window}.
...
* Les kits de démarrage (Starter Kits) constituent l'une des façons les plus rapides d'utiliser les fonctions d'{{site.data.keyword.cloud_notm}}. Affichez les kits de démarrage disponibles dans le tableau de bord [Mobile developer dashboard ![Icône de lien externe](../icons/launch-glyph.svg "Icône de lien externe")](https://console.bluemix.net/developer/mobile/dashboard){:new_window}. Téléchargez le code. Exécutez l'application !
